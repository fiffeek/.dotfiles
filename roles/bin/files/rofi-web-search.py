...
# credit: https://github.com/pdonadeo/rofi-web-search
# adapted, changed ad-hoc, todo(fmikina, 19.07.2025): actually
# make this readable and extensible
...
def focus_i3_browser_window():
    os.system('I3SOCK=$(i3 --get-socketpath) i3-msg workspace "4" >/dev/null')
